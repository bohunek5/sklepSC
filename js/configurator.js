document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderResults() {
    ...
    if (!candidates.length) {
      results.hidden = false;
      resultContent.innerHTML = '<div class="no-results"><h3>Ta kombinacja nie występuje w aktualnym katalogu.</h3><p>Wróć o krok i zmień jeden parametr. Konfigurator nie zastąpi brakującego produktu przypadkowym odpowiednikiem.</p><button class="mockup-btn" style="background: transparent; color: #08192f; border: 1px solid #08192f; margin-top: 15px;" onmouseover="this.style.background='#08192f'; this.style.color='#fff'" onmouseout="this.style.background='transparent'; this.style.color='#08192f'" type="button" id="returnToConfiguration">Wróć do konfiguracji</button></div>';
